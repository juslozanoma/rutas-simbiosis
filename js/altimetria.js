const AltimetriaModule = (() => {
  ...
  function _construir(cont) {
    if (!_rutaGeojson || !_rutaGeojson.geometry) { cont.innerHTML = '<div class="empty-state"><img src="/rutas-simbiosis/simbiosis.png" alt="" class="empty-state__icono"><span class="empty-state__texto">Calcula una ruta primero</span></div>'; return; }
